...
public class Sprites : MonoBehaviour
{
    ...
    public List<Sprite> CopperSprites = new List<Sprite>();
    ...
    public List<Sprite> GeneratorSprites = new List<Sprite>();
    public List<Sprite> CrafterSprites = new List<Sprite>();
    public List<Sprite> StorageContainerSprites = new List<Sprite>();
